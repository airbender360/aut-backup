...
linkPlaylist = r'https://www.youtube.com/playlist?list=PLAKTtN7vEpniGY0qIWWQFQpClbJtRYIjG'
...
# example:
# yt-dlp -o "D:\videos\%(title)s.%(ext)s" https://www.youtube.com/watch?v=j62h1eJxx8U